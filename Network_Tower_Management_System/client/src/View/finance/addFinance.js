...
const AddFinance = () => {
  ...
  // budgetPoAmount
  const [budgetPoAmount, setBudgetPoAmount] = useState(0);
  ...
  switch (tabs[0][0]) {
    case 'budgetPoAmount':
      ...
      isFormValid = !isNegative && budgetPoAmount !== '' && budgetPoAmount % budgetPoAmount === 0;
      break;
    case 'actualPoAmount':
      isNegative = actualPoAmount <= 0;
      isFormValid = !isNegative && actualPoAmount !== '' && actualPoAmount % actualPoAmount === 0;
      break;
    case 'invoiceAmount':
      isNegative = invoiceAmountExTax <= 0;
      isFormValid = !isNegative && invoiceAmountExTax !== '' && invoiceAmountExTax % invoiceAmountExTax === 0;
      break;
    case 'cashCollection':
